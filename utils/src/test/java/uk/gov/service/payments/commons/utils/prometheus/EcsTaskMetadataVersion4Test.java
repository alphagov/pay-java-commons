...
public class EcsTaskMetadataVersion4Test {
    ...
    void shouldThrowExceptionIfInvalidJsonProvided() {
        ...
        assertThrows(JSONException.class, () -> new EcsTaskMetadataVersion4(new String(EcsTaskMetadataVersion4Test.class.getClassLoader().getResourceAsStream("ecs-metadata-no-containers.json").readAllBytes())));
    }
