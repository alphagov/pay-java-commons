...
class RestClientLoggingFilterTest {
    ...
    @Test
    void shouldLogRestClientStartEventWithRequestId() {
    ...
    @Test
    void shouldLogRestClientEndEventWithRequestIdAndElapsedTime() {
        ...
        Assertions.assertTrue(NumberUtils.isCreatable(timeTaken[0]));
    }
}
